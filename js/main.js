...
window.addEventListener('load', function () {
    ...
    setTimeout(function () {
        iziToast.show({
            title: hello,
            message: '欢迎来到 LiCheng - Originate'
        });
    }, 800);
...
fetch('https://v0.yiketianqi.com/api?unescape=1&version=v61&appid=86127333&appsecret=yWA4TQwr')
...
// let title2 = `
 ...
 // | |   | | |   | '_ \ / _ \ '_ \ / _` |
 // | |___| | |___| | | |  __/ | | | (_| |
 // |_____|_|\____|_| |_|\___|_| |_|\__, |
 //                                 |___/

let title2 = `
https://lcclc.cn/
微信:https://lccoc.top/img/WeChat.png
QQ:https://lccoc.top/img/QQ.png
邮箱:lyhc65@163.com
`
let content = `
主页:  https://lcclc/cn
